...
// import RevealWinnerComponent from "@/components/reveal-winner";
...
//             <Wallet className="mx-auto mb-4 w-12 h-12 text-blue-400" />
//             <p className="text-white text-lg mb-4">
//               Connect your wallet to interact with the RichestComparison contract
//             </p>
//             <button
//               onClick={handleConnect}
//               className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-lg transition-colors"
    ...
    <div className="bg-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto p-6">
        ...
        {isConnected ? (
          <ContractProvider>
            {/* Deploy Component */}
            <div className="bg-gray-800 p-6 rounded-lg mb-12 border border-gray-700 shadow-lg">
              <h2 className="text-xl font-semibold text-white mb-4">
                Deploy the RichestComparison Contract
              </h2>
              <DeployRichest />
            </div>
